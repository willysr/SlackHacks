...
vmmon=vmmon-4.4.patch
vmci=vmci-4.4.patch
vmnet=vmnet-4.4.patch
vmreqver=10.0.6
plreqver=7.1.2
...
[ ! -f "$vmmon" ] && error "'$vmmon' not found. Please, copy it to the current '$curdir' directory"
[ ! -f "$vmci" ] && error "'$vmci' not found. Please, copy it to the current '$curdir' directory"
